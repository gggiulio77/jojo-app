...
use crate::sidebar_devices::SidebarDevices;
...
pub fn App() -> impl IntoView {
    ...
    view! {
        ...
        <main class="drawer">
            ...
            <Router>
                <Routes>
                    <Route path="/" view=SidebarDevices>
                        <Route path=":id" view=DeviceConfig/>
                        <Route path="" view=move || {
                            view! {
                                <div class="drawer-content grid h-[calc(100vh-64px)] place-items-center">
                                    <div class="card w-60 bg-accent text-accent-content">
